...
// ======================================================
// TAMBAHKAN INI UNTUK TOTAL TERSALURKAN
// ======================================================
    ...
    <div class="program-header">
        ...
        <div class="program-stats">
            ...
            <div class="stat-box"><h3><?php echo $program['jumlah_donatur']; ?></h3><p>Donatur</p></div>
             <div class="stat-box">
        <h3>Rp <?php echo number_format($total_tersalurkan, 0, ',', '.'); ?></h3>
        <p>Tersalurkan</p>
    </div>
        </div>
        ...
        <div class="donatur-list">
            <div class="card">
                ...
                <?php if (count($donatur_list) > 0): ?>
                    ...
                    <?php endforeach; ?>
                    <!-- ========================================== -->
            <!-- TOMBOL LIHAT SEMUA DONATUR (TARUH DI SINI) -->
            <!-- ========================================== -->
...
<script>
    // Toggle nama field berdasarkan pilihan anonim
