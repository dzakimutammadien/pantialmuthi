...
// DASHBOARD ADMIN - SUSUNAN CARD SESUAI REQUEST
// ======================================================
...
<head>
    ...
    margin-left: auto;
        ...
        .profile-icon { width: 45px; height: 45px; background: linear-gradient(135deg, #50c878, #2e8b57); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 20px; cursor: pointer; transition: all 0.3s ease; }
        .profile-icon:hover { transform: scale(1.05); }
        .dropdown-menu { position: absolute; top: 55px; right: 0; background: white; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.15); width: 200px; opacity: 0; visibility: hidden; transition: all 0.3s ease; z-index: 1000; }
        .profile-dropdown:hover .dropdown-menu { opacity: 1; visibility: visible; }
        .dropdown-menu a { display: flex; align-items: center; gap: 12px; padding: 12px 20px; color: #333; text-decoration: none; font-size: 14px; transition: all 0.3s ease; border-bottom: 1px solid #f0f0f0; }
        ...
        .card-donatur .stat-icon { background: #e8eaf6; color: #3f51b5; }
        .card-anak .stat-icon { background: #fce4ec; color: #e91e63; }
        .card-pengasuh .stat-icon { background: #e0f7fa; color: #0097a7; }
        
        .card-pending .stat-icon { background: #fff3e0; color: #ff9800; }
        
        /* BORDER LEFT UNTUK SETIAP BARIS */
        ...
        .baris-4 .stat-card { border-left: 4px solid #3f51b5; }
        .baris-4 .stat-card:nth-child(2) { border-left-color: #e91e63; }
        .baris-4 .stat-card:nth-child(3) { border-left-color: #0097a7; }
        
        .baris-5 .stat-card { border-left: 4px solid #ff9800; }
        .baris-5 .stat-card:nth-child(2) { border-left-color: #ff9800; }
        .baris-5 .stat-card:nth-child(3) { border-left-color: #ff9800; }
        ...
        .badge-penyaluran { background: #fff3e0; color: #e65100; padding: 3px 10px; border-radius: 20px; font-size: 11px; display: inline-block; }
...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            ...
            <div class="profile-dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="log_aktivitas.php"><i class="fas fa-history"></i><span>Log Aktivitas</span></a>
        ...
        <!-- ============================================================ -->
        <!-- BARIS 1: KEUANGAN DONASI BIASA                                 -->
        <!-- ============================================================ -->
        <div class="section-title">
            <i class="fas fa-hand-holding-heart" style="color:#4caf50;"></i>
            <span>Keuangan Donasi Biasa</span>
        ...
        <div class="stats-grid baris-1">
            <div class="stat-card card-pemasukan">
                <div class="stat-info">
                    ...
                    <small>Donasi biasa success</small>
                </div>
        ...
        <div class="stats-grid baris-2">
            <div class="stat-card card-program">
                <div class="stat-info">
                    ...
                    <small>Donasi program success</small>
                </div>
        ...
        <!-- ============================================================ -->
        <div class="section-title">
            <i class="fas fa-users" style="color:#3f51b5;"></i>
            <span>Data User & Anak Asuh</span>
        </div>
        <div class="stats-grid baris-4">
            <div class="stat-card card-donatur">
                <div class="stat-info">
                    <h4><i class="fas fa-user-friends"></i> Jumlah Donatur</h4>
                    <div class="value"><?php echo $totalDonatur; ?></div>
                    <small>Orang</small>
                </div>
                <div class="stat-icon"><i class="fas fa-users"></i></div>
            </div>
            ...
            <div class="stat-card card-pengasuh">
                <div class="stat-info">
                    <h4><i class="fas fa-chalkboard-user"></i> Jumlah Pengasuh</h4>
                    <div class="value"><?php echo $totalPengasuh; ?></div>
                    <small>Orang</small>
                </div>
        ...
        <div class="stats-grid baris-5">
            <div class="stat-card card-pending">
                <div class="stat-info">
                    <h4><i class="fas fa-hand-holding-heart"></i> Verifikasi Donasi</h4>
                    <div class="value"><?php echo $totalDonasiPending; ?></div>
            ...
            <div class="stat-card card-pending">
                <div class="stat-info">
                    <h4><i class="fas fa-money-bill-wave"></i> Verifikasi Pengeluaran</h4>
                    <div class="value"><?php echo $totalPengeluaranPending; ?></div>
                    <small>Transaksi</small>
                </div>
            ...
            <div class="stat-card card-pending">
                <div class="stat-info">
                    <h4><i class="fas fa-chalkboard-user"></i> Verifikasi Program</h4>
                    <div class="value"><?php echo $totalProgramPending; ?></div>
                    <small>Donasi</small>
                </div>
        ...
        <div class="quick-actions">
            ...
            <a href="verifikasi_program.php" class="action-btn">
                <i class="fas fa-heart"></i>
                <h4>Verifikasi Program</h4>
                <p>Validasi donasi crowdfunding</p>
            </a>
            <a href="program.php" class="action-btn">
                <i class="fas fa-chalkboard-user"></i>
                <h4>Kelola Program</h4>
                <p>Program & penerima manfaat</p>
            </a>
        </div>
