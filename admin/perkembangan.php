...
<head>
    ...
    <title>Perkembangan Anak Asuh - Admin Panti Asuhan Al-Muthi</title>
...
<div class="submenu open">
 ...
 <div class="menu-item" onclick="location.href='verifikasi_pendaftaran.php'">
    ...
    <div class="main-content">
        <div class="topbar">
            <div class="page-title"><h2>Perkembangan Anak Asuh</h2><p>Pantau perkembangan kesehatan & pendidikan (Read Only)</p></div>
    ...
    <script>
        function toggleSubmenu(e){
            ...
            if(s && s.classList.contains('submenu')) s.classList.toggle('open');
        }
    </script>
</body>
</html>